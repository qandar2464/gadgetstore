                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    ...
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">'.$productName. '</a></h5><span class="text-muted font-weight-normal font-italic d-block">MYR. ' .$productPrice. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
