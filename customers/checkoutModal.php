...
<div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            <form action="customers/manageCart.php" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="No.Phone" required pattern="[0-9]{10}" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group col-md-6 mb-0">
                        <b><label for="zipcode">Zip Code:</label></b>
                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="ZIPCODE" required pattern="[0-9]{5}" maxlength="5">                    
                    </div>
                </div>
                <div class="form-group">
