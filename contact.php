...
<html lang="en">
  ...
  <div class="container">
    <div class="my-3" style="width : 1000px;">
                ...
                <div class="row">
                  <div class="col">
                    <div class="contact-box p-4">
                      ...
                      ?>
                      <form action="customers/manageContactUs.php" method="POST">
                        <div class="row">
                          <div class="col-lg-6">
                          ...
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn btn-primary mt-3 mb-3"><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
                              <button type="button" class="btn btn btn-primary mt-3 mb-3" data-toggle="modal" data-target="#history"><span> HISTORY <i class="ti-arrow-right"></i></span></button>
                            </div>
                          <?php }else { ?>
                            <div class="col-lg-12">
                              ...
                              <h3 class="form-text text-muted">Please login first before use.</h3>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
