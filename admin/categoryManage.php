<div class="container-fluid" style="margin-top:98px">
    <div class="col-lg-12">
        <div class="row">
            <!-- FORM Panel -->
            <div class="col-md-4">
                <form action="sub/categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td><img src="/gadgetstore/img/product-'.$catId. '.png" alt="image for this Category" width="150px" height="150px"></td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="sub/categoryManage.php" method="POST">
        ...
        <form action="sub/categoryManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<input type="file" name="catimage" id="catimage" accept=".png" class="form-control" required style="border:none;" onchange="document.getElementById('itemPhoto').src = window.URL.createObjectURL(this.files[0])">
					<small id="Info" class="form-text text-muted mx-3">Please .png file upload.</small>
				...
				<div class="form-group col-md-4">
					<img src="/gadgetstore/img/product-<?php echo $catId; ?>.png" id="itemPhoto" name="itemPhoto" alt="Category image" width="100" height="100">
				</div>
			</div>
		</form>
        <form action="sub/categoryManage.php" method="post">
