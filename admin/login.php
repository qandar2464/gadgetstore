...
<head>
    ...
    <title>Login</title>
    <link rel = "icon" href ="/gadgetstore/img/aboutus.png" type = "image/x-icon">
    
</head>
<body>
<div class="bg-image" style="background-image:url(img/background.png);height: 1000px;">
    <div class="container" style="min-height : 610px; width: 20cm;"></br></br></br>
    <div class="card my-3" style="padding: 30px;">
        <div class="box my-3">
            <center><h2>Admins Login</h2></center>
            <form action="sub/handleLogin.php" method="post">
