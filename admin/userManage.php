                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/gadgetstore/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/gadgetstore/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            ...
                                            if($Id == 1) {
                                                ...
                                                echo '<form action="sub/userManage.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="sub/userManage.php" method="post">
