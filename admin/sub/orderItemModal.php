                                ...
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/gadgetstore/img/product-'.$productId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$productName. '</h5><span class="text-muted font-weight-normal font-italic d-block">MYR. ' .$productPrice. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
